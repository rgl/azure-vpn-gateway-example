...
$backgroundColor = [System.Drawing.Color]::FromArgb(0, 113, 197) #0071c5
$backgroundPath = 'C:\Windows\Web\Wallpaper\Windows\azure.png'
$logo = [System.Drawing.Image]::FromFile((Resolve-Path 'azure.png'))
